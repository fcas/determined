...
func request_Determined_ModifyWorkspaceNamespaceBinding_0(ctx context.Context, marshaler runtime.Marshaler, client DeterminedClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ModifyWorkspaceNamespaceBindingRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.ModifyWorkspaceNamespaceBinding(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_Determined_ModifyWorkspaceNamespaceBinding_0(ctx context.Context, marshaler runtime.Marshaler, server DeterminedServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ModifyWorkspaceNamespaceBindingRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ModifyWorkspaceNamespaceBinding(ctx, &protoReq)
	return msg, metadata, err

}

func request_Determined_SetResourceQuota_0(ctx context.Context, marshaler runtime.Marshaler, client DeterminedClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SetResourceQuotaRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.SetResourceQuota(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_Determined_SetResourceQuota_0(ctx context.Context, marshaler runtime.Marshaler, server DeterminedServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SetResourceQuotaRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.SetResourceQuota(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterDeterminedHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DeterminedServer) error {
	...
	mux.Handle("POST", pattern_Determined_ModifyWorkspaceNamespaceBinding_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_Determined_ModifyWorkspaceNamespaceBinding_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Determined_ModifyWorkspaceNamespaceBinding_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_Determined_SetResourceQuota_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_Determined_SetResourceQuota_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Determined_SetResourceQuota_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterDeterminedHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DeterminedClient) error {
	...
	mux.Handle("POST", pattern_Determined_ModifyWorkspaceNamespaceBinding_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Determined_ModifyWorkspaceNamespaceBinding_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_Determined_SetResourceQuota_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Determined_SetResourceQuota_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_Determined_ModifyWorkspaceNamespaceBinding_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"api", "v1", "workspaces", "id", "bind"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Determined_SetResourceQuota_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"api", "v1", "workspaces", "id", "quota"}, "", runtime.AssumeColonVerbOpt(true)))
...
var (
	...
	forward_Determined_ModifyWorkspaceNamespaceBinding_0 = runtime.ForwardResponseMessage

	forward_Determined_SetResourceQuota_0 = runtime.ForwardResponseMessage
